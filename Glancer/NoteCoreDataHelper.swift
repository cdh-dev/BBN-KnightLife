...
class NoteCoreDataHelper {
    ...
    static func readNotesFromCoreData(fromManagedObjectContext: NSManagedObjectContext) -> [NoteData] {

        var returnedNotes = [NoteData]()
        ...
        do {
            ...
            fetchedNotesFromCoreData.forEach { (fetchRequestResult) in
                ...
                returnedNotes.append(NoteData.init(
    ...
    static func readNoteFromCoreData(
        noteIdToBeRead:           UUID,
        fromManagedObjectContext: NSManagedObjectContext) -> NoteData? {
