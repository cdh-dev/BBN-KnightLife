...
//			// Check if course during this block
//			if let course = self.bestCourse {
//				return course.name
//			}
//
//			// Check if any annotations
//			if let annotation = self.bestAnnotation {
//				return annotation.title
//			}
//
//			// Check if this is a lab block
//			if let labBlock = self.labAssociatedBlock {
//				return labBlock.analyst.displayName
//			}
//
//		}
